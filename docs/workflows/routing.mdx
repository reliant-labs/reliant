...
- **one-ring** — routes to discuss, planning, write_tests, or impl_loop
- **bmad-lite** — routes to discuss, ideate, requirements, architecture, or implement
...
- id: classify
  ...
  nodes:
    - id: discuss
      description: "Ambiguous request — clarify before starting"
    - id: planning
...
With no outgoing edges, the engine dispatches directly to the selected node. This lets users say "just implement it" and skip research/planning phases entirely, or say something vague and land in a discussion phase first.
