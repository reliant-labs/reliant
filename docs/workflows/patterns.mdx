...
<Tip>
For simple linear chains, consider using `sequence:` syntax sugar instead of writing explicit edges. See [Syntax Sugar](/workflows/custom-workflows#syntax-sugar).
</Tip>
...
<Tip>
You can simplify the parallel fan-out/join pattern with `type: parallel` syntax sugar. See [Syntax Sugar](/workflows/custom-workflows#syntax-sugar) for the compact form.
</Tip>
