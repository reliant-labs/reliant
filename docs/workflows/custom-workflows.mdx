...
```yaml
# Mixed: linear main flow with an extra branch
sequence:
  - id: research
    type: workflow
    ref: builtin://agent
...
# Additional nodes and edges for branching
nodes:
  - id: notify
    type: run
    command: echo "Done"
...
nodes:
  - id: research
    ...
    ref: builtin://agent
    args:
      system_prompt: Research the problem
  - id: design
    type: workflow
    ref: builtin://agent
    args:
