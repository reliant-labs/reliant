...
**one-ring** and **bmad-lite** are multi-phase pipeline workflows that use [node routers](/workflows/routing#node-routing) for phase skipping. Users can jump directly to the relevant phase (planning, implementation, etc.) based on their request.
