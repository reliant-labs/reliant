...
| [`reliant workflow cancel`](#reliant-workflow-cancel) | Cancel a running workflow execution |
...
| [`cancel`](#reliant-workflow-cancel) | Cancel a running workflow execution |
...
### reliant workflow cancel

Cancel a running workflow execution

Cancels the workflow for a chat via ChatService.CancelChat. Cancel is
