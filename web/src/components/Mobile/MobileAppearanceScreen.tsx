 ...
 * imports Monaco or `MonacoEditorSettings` (the desktop panel's
 * collapsed-by-default "Editor (advanced)" section), matching the `/m/*`
 * bundle's exclusion of the eager Monaco preload (see `main.tsx`'s
 * `shouldPreloadMonaco`).
 */
