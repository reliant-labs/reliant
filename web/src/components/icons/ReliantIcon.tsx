...
/**
 * Reliant logo as a React icon component.
 * Can be used like Lucide icons with className for sizing.
 * 
 * The viewBox is adjusted to be square (-252.49 0 1187.07 1187.07) to center
...
export const ReliantIcon = forwardRef<SVGSVGElement, ReliantIconProps>(
  (
    ...
    // Vertical offset = (1187.07 - 682.09) / 2 = 252.49
    // So minY = -252.49 to center the content
    return (
      <svg
        ref={ref}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="-50 -252.49 1287.07 1187.07"
        width={size}
        height={size}
        className={className}
        fill="currentColor"
...
ReliantIcon.displayName = "ReliantIcon";