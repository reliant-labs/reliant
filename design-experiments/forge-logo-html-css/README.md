...
```bash
forge ui-audit http://127.0.0.1:4173/?mesh=2 --profile generic --scope '[data-audit="forge-logo-html-css"]' --out /Users/seanteeling/.reliant/worktrees/00e933a0b4ee/feat/nw-wf/design-experiments/forge-logo-html-css/ui-audit --wait-for '[data-audit="forge-logo-html-css"]' --timeout 30000
```
