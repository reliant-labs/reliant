...
type Querier interface {
	...
	GetNextSequenceNumber(ctx context.Context, chatID string) (int32, error)
	...
	ListRootWorkflowsByStatus(ctx context.Context, status int32) ([]Workflow, error)
	...
	ListWorkflowsByStatus(ctx context.Context, status int32) ([]Workflow, error)
	ListWorktrees(ctx context.Context, arg ListWorktreesParams) ([]Worktree, error)
	MarkAgentMessagesDelivered(ctx context.Context, arg MarkAgentMessagesDeliveredParams) error
