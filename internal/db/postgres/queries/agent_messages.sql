...
-- name: CancelQueuedAgentMessage :execrows
...
-- name: ClaimQueuedAgentMessagesForThread :many
...
-- name: MarkQueuedAgentMessagesUndeliveredForThread :execrows
...
-- name: ListThreadsWithOrphanedAgentMessages :many
...
-- name: EnqueueAgentMessageIfAbsent :one
