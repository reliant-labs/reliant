...
//
//forge:lint-disable-next-line forge-exclude-contract-multi-impl: Collector (global vs local) is an accumulator strategy over one error type, not a service; tracked in H-RELIANT-CI-lint follow-ups
//forge:exclude-contract: validation error types and collectors
package validation
