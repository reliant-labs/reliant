...
description: Performance and concurrency review methodology — scalability analysis, race condition detection, and resource leak identification
---
...
#### Big-O Regressions
- **Nested loops**: O(n²) or worse where O(n) is possible
...
- Keep suggestions proportional to the change. Small UI changes, copy updates, or config tweaks rarely have meaningful performance implications — acknowledge this and move on rather than searching for micro-optimizations.
