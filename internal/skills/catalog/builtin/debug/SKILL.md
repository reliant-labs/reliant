---
name: debug
description: Debugging orchestration methodology — parallel investigation coordination, hypothesis formation, test-based isolation, and structured bug reports
---
...
Load the reproduction sub-skill for detailed methodology: `skill(action="load", path="debug/reproduction-methodology")`

Perform runtime reproduction yourself (or spawn a researcher with reproduction instructions):
...
# For reproduction, load the sub-skill and do it yourself, or include reproduction instructions
# in the researcher or tester spawn prompts.
```
