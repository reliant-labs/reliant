---
name: reliant-config
description: Configure Reliant — memory files, skills, MCP servers, presets, and config YAML. Use when adding instructions, creating skills, connecting tools, or customizing agent behavior.
