...
const file_reliant_v1_filesystem_proto_rawDesc = "" +
	...
	"\n" +
	"is_symlink\x18\x05 \x01(\bR\tisSymlink*e\n" +
	...
	"\x17FILE_VIEWER_KIND_BINARY\x10\x062\xff\a\n" +
	...
	"\x12GetFilePreviewInfo\x12%.reliant.v1.GetFilePreviewInfoRequest\x1a&.reliant.v1.GetFilePreviewInfoResponse\"\x00\x12e\n" +
...
var file_reliant_v1_filesystem_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
...
var file_reliant_v1_filesystem_proto_depIdxs = []int32{
	...
	15, // 17: reliant.v1.FileSystemService.CreateFileOrFolder:input_type -> reliant.v1.CreateFileOrFolderRequest
	17, // 18: reliant.v1.FileSystemService.DeleteFileOrFolder:input_type -> reliant.v1.DeleteFileOrFolderRequest
	19, // 19: reliant.v1.FileSystemService.CopyFile:input_type -> reliant.v1.CopyFileRequest
	21, // 20: reliant.v1.FileSystemService.SearchFiles:input_type -> reliant.v1.SearchFilesRequest
	25, // 21: reliant.v1.FileSystemService.ReplaceInFiles:input_type -> reliant.v1.ReplaceInFilesRequest
	28, // 22: reliant.v1.FileSystemService.ListDirectory:input_type -> reliant.v1.ListDirectoryRequest
	6,  // 23: reliant.v1.FileSystemService.GetFileTree:output_type -> reliant.v1.GetFileTreeResponse
	8,  // 24: reliant.v1.FileSystemService.GetFileContent:output_type -> reliant.v1.GetFileContentResponse
	10, // 25: reliant.v1.FileSystemService.SaveFileContent:output_type -> reliant.v1.SaveFileContentResponse
	12, // 26: reliant.v1.FileSystemService.GetFileMetadata:output_type -> reliant.v1.GetFileMetadataResponse
	14, // 27: reliant.v1.FileSystemService.GetFilePreviewInfo:output_type -> reliant.v1.GetFilePreviewInfoResponse
	16, // 28: reliant.v1.FileSystemService.CreateFileOrFolder:output_type -> reliant.v1.CreateFileOrFolderResponse
	18, // 29: reliant.v1.FileSystemService.DeleteFileOrFolder:output_type -> reliant.v1.DeleteFileOrFolderResponse
	20, // 30: reliant.v1.FileSystemService.CopyFile:output_type -> reliant.v1.CopyFileResponse
	22, // 31: reliant.v1.FileSystemService.SearchFiles:output_type -> reliant.v1.SearchFilesResponse
	26, // 32: reliant.v1.FileSystemService.ReplaceInFiles:output_type -> reliant.v1.ReplaceInFilesResponse
	29, // 33: reliant.v1.FileSystemService.ListDirectory:output_type -> reliant.v1.ListDirectoryResponse
