...
type AvailableModelInfo struct {
	...
	// Whether the model supports file attachments.
	SupportsAttachments bool `protobuf:"varint,11,opt,name=supports_attachments,json=supportsAttachments,proto3" json:"supports_attachments,omitempty"`
	// Whether the model supports tool/function calling.
	SupportsTools bool `protobuf:"varint,12,opt,name=supports_tools,json=supportsTools,proto3" json:"supports_tools,omitempty"`
	// Whether the model supports caching.
	SupportsCaching bool `protobuf:"varint,13,opt,name=supports_caching,json=supportsCaching,proto3" json:"supports_caching,omitempty"`
	// Model tags for categorization (e.g., "flagship", "fast", "cheap").
...
func (x *AvailableModelInfo) GetFamily() string {
	if x != nil {
		return x.Family
	}
	return ""
...
func (x *AvailableModelInfo) GetApiModel() string {
	if x != nil {
		return x.ApiModel
	}
	return ""
...
func (x *AvailableModelInfo) GetContextWindow() int64 {
	if x != nil {
		return x.ContextWindow
	}
	return 0
...
func (x *AvailableModelInfo) GetCanReason() bool {
	if x != nil {
		return x.CanReason
	}
	return false
...
func (x *AvailableModelInfo) GetSupportsAttachments() bool {
	if x != nil {
		return x.SupportsAttachments
	}
	return false
...
func (x *AvailableModelInfo) GetSupportsTools() bool {
	if x != nil {
		return x.SupportsTools
	}
	return false
...
func (x *AvailableModelInfo) GetSupportsCaching() bool {
	if x != nil {
		return x.SupportsCaching
	}
	return false
...
func (x *AvailableModelInfo) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *AvailableModelInfo) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
const file_reliant_v1_catalog_proto_rawDesc = "" +
	...
	"\x14supports_attachments\x18\v \x01(\bR\x13supportsAttachments\x12%\n" +
	...
	"\x14ListModelsByProvider\x12'.reliant.v1.ListModelsByProviderRequest\x1a(.reliant.v1.ListModelsByProviderResponse\"\x00\x12h\n" +
