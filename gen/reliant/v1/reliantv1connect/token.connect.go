...
const (
	...
	TokenServiceName = "reliant.v1.TokenService"
)
...
const (
	...
	// RPC.
	TokenServiceCreateTokenProcedure = "/reliant.v1.TokenService/CreateToken"
	// TokenServiceListTokensProcedure is the fully-qualified name of the TokenService's ListTokens RPC.
	TokenServiceListTokensProcedure = "/reliant.v1.TokenService/ListTokens"
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	tokenServiceMethods := v1.File_reliant_v1_token_proto.Services().ByName("TokenService").Methods()
...
// ListTokens calls reliant.v1.TokenService.ListTokens.
...
// RevokeToken calls reliant.v1.TokenService.RevokeToken.
...
func (UnimplementedTokenServiceHandler) CreateToken(context.Context, *connect.Request[v1.CreateTokenRequest]) (*connect.Response[v1.CreateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reliant.v1.TokenService.CreateToken is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) ListTokens(context.Context, *connect.Request[v1.ListTokensRequest]) (*connect.Response[v1.ListTokensResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reliant.v1.TokenService.ListTokens is not implemented"))
}
