...
const (
	...
	ToolCallStatus_TOOL_CALL_STATUS_CANCELLED    ToolCallStatus = 5
	ToolCallStatus_TOOL_CALL_STATUS_BACKGROUNDED ToolCallStatus = 6
)
...
var (
	ToolCallStatus_name = map[int32]string{
		...
		5: "TOOL_CALL_STATUS_CANCELLED",
		6: "TOOL_CALL_STATUS_BACKGROUNDED",
	}
...
type ContentBlock struct {
	...
	ToolCallStatus *ToolCallStatus        `protobuf:"varint,10,opt,name=tool_call_status,json=toolCallStatus,proto3,enum=reliant.v1.ToolCallStatus,oneof" json:"tool_call_status,omitempty"` // Durable status, for tool_call blocks
	StartedAt      *string                `protobuf:"bytes,11,opt,name=started_at,json=startedAt,proto3,oneof" json:"started_at,omitempty"`                                                  // Durable status timing, for tool_call blocks
	CompletedAt    *string                `protobuf:"bytes,12,opt,name=completed_at,json=completedAt,proto3,oneof" json:"completed_at,omitempty"`                                            // Durable status timing, for tool_call blocks
	...
	ChildWorkflowId *string `protobuf:"bytes,13,opt,name=child_workflow_id,json=childWorkflowId,proto3,oneof" json:"child_workflow_id,omitempty"` // For spawn tool_call blocks
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ContentBlock) GetToolCallStatus() ToolCallStatus {
	if x != nil && x.ToolCallStatus != nil {
		return *x.ToolCallStatus
	}
	return ToolCallStatus_TOOL_CALL_STATUS_UNSPECIFIED
}

func (x *ContentBlock) GetStartedAt() string {
...
func (x *ContentBlock) GetCompletedAt() string {
...
func (x *ContentBlock) GetChildWorkflowId() string {
...
func (x *SendAgentMessageRequest) GetThreadId() string {
	if x != nil {
		return x.ThreadId
	}
	return ""
...
func (x *SendAgentMessageRequest) GetAttachments() []string {
	if x != nil {
		return x.Attachments
	}
	return nil
...
type SendAgentMessageResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // Human-readable receipt, or the reason for failure.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SendAgentMessageResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ListQueuedAgentMessagesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChatId        string                 `protobuf:"bytes,1,opt,name=chat_id,json=chatId,proto3" json:"chat_id,omitempty"`
...
func (x *ListQueuedAgentMessagesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListQueuedAgentMessagesRequest) GetThreadId() string {
	if x != nil {
		return x.ThreadId
	}
	return ""
...
type QueuedAgentMessage struct {
	...
	SenderKind    int32    `protobuf:"varint,4,opt,name=sender_kind,json=senderKind,proto3" json:"sender_kind,omitempty"`
	Attachments   []string `protobuf:"bytes,5,rep,name=attachments,proto3" json:"attachments,omitempty"` // Attachment IDs
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *QueuedAgentMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *QueuedAgentMessage) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *QueuedAgentMessage) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *QueuedAgentMessage) GetSenderKind() int32 {
	if x != nil {
		return x.SenderKind
	}
	return 0
...
func (x *QueuedAgentMessage) GetAttachments() []string {
	if x != nil {
		return x.Attachments
	}
	return nil
...
type ListQueuedAgentMessagesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListQueuedAgentMessagesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CancelQueuedAgentMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChatId        string                 `protobuf:"bytes,1,opt,name=chat_id,json=chatId,proto3" json:"chat_id,omitempty"`
...
func (x *CancelQueuedAgentMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CancelQueuedAgentMessageRequest) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
type CancelQueuedAgentMessageResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // Human-readable receipt, or the reason it couldn't be cancelled.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CancelQueuedAgentMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CancelQueuedAgentMessageResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ListMessagesRequest struct {
	...
	BeforeSeq *int64                 `protobuf:"varint,3,opt,name=before_seq,json=beforeSeq,proto3,oneof" json:"before_seq,omitempty"` // Load messages before this seq
...
type ListMessagesResponse struct {
	...
	OldestSeq     int64                  `protobuf:"varint,5,opt,name=oldest_seq,json=oldestSeq,proto3" json:"oldest_seq,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListMessagesResponse) GetOldestSeq() int64 {
	if x != nil {
		return x.OldestSeq
	}
	return 0
...
const file_reliant_v1_chat_proto_rawDesc = "" +
	...
	"\x0ematched_result\x18\t \x01(\v2\x1d.reliant.v1.MatchedToolResultH\x05R\rmatchedResult\x88\x01\x01\x12I\n" +
	"\x10tool_call_status\x18\n" +
	" \x01(\x0e2\x1a.reliant.v1.ToolCallStatusH\x06R\x0etoolCallStatus\x88\x01\x01\x12\"\n" +
	"\n" +
	"started_at\x18\v \x01(\tH\aR\tstartedAt\x88\x01\x01\x12&\n" +
	"\fcompleted_at\x18\f \x01(\tH\bR\vcompletedAt\x88\x01\x01\x12/\n" +
	"\x11child_workflow_id\x18\r \x01(\tH\tR\x0fchildWorkflowId\x88\x01\x01B\n" +
	"\n" +
	"\b_contentB\f\n" +
	"\n" +
	"_tool_nameB\x0f\n" +
	...
	"\x06_inputB\v\n" +
	"\t_is_errorB\x11\n" +
	"\x0f_matched_resultB\x13\n" +
	"\x11_tool_call_statusB\r\n" +
	"\v_started_atB\x0f\n" +
	"\r_completed_atB\x14\n" +
	"\x12_child_workflow_id\"\xa1\x01\n" +
	...
	"\x1eListQueuedAgentMessagesRequest\x12\x17\n" +
	"\achat_id\x18\x01 \x01(\tR\x06chatId\x12\x1b\n" +
	"\tthread_id\x18\x02 \x01(\tR\bthreadId\"\x9a\x01\n" +
	"\x12QueuedAgentMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04body\x18\x02 \x01(\tR\x04body\x12\x1d\n" +
	"\n" +
	"created_at\x18\x03 \x01(\tR\tcreatedAt\x12\x1f\n" +
	"\vsender_kind\x18\x04 \x01(\x05R\n" +
	"senderKind\x12 \n" +
	"\vattachments\x18\x05 \x03(\tR\vattachments\"]\n" +
	"\x1fListQueuedAgentMessagesResponse\x12:\n" +
	"\bmessages\x18\x01 \x03(\v2\x1e.reliant.v1.QueuedAgentMessageR\bmessages\"Y\n" +
	"\x1fCancelQueuedAgentMessageRequest\x12\x17\n" +
	...
	"\n" +
	"before_seq\x18\x03 \x01(\x03H\x01R\tbeforeSeq\x88\x01\x01\x12 \n" +
	"\tthread_id\x18\x04 \x01(\tH\x02R\bthreadId\x88\x01\x01B\t\n" +
	"\a_recentB\r\n" +
	"\v_before_seqB\f\n" +
	"\n" +
	"_thread_id\"\xad\x01\n" +
	...
	"\n" +
	"oldest_seq\x18\x05 \x01(\x03R\toldestSeq\"^\n" +
	...
	"\x17TOOL_CALL_STATUS_FAILED\x10\x04\x12\x1e\n" +
	"\x1aTOOL_CALL_STATUS_CANCELLED\x10\x05\x12!\n" +
	"\x1dTOOL_CALL_STATUS_BACKGROUNDED\x10\x06*i\n" +
