...
func (TerminalSessionEvent_EventType) EnumDescriptor() ([]byte, []int) {
	return file_reliant_v1_tools_daemon_proto_rawDescGZIP(), []int{37, 0}
}
...
type DaemonRegister struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DaemonId      string                 `protobuf:"bytes,1,opt,name=daemon_id,json=daemonId,proto3" json:"daemon_id,omitempty"`       // Unique daemon instance ID
...
const file_reliant_v1_tools_daemon_proto_rawDesc = "" +
	...
	"workingDir\x12\"\n" +
	"\fcapabilities\x18\x06 \x03(\tR\fcapabilitiesJ\x04\b\a\x10\b\"\x80\x02\n" +
	...
	"\fproject_path\x18\x01 \x01(\tR\vprojectPath\"\xb4\x05\n" +
	...
	"\x11project_memory_md\x18\f \x01(\fR\x0fprojectMemoryMd\x1a=\n" +
	...
	"\fcontent_hash\x18\x04 \x01(\tR\vcontentHash\x12\"\n" +
	"\rmtime_unix_ms\x18\x05 \x01(\x03R\vmtimeUnixMs\x12!\n" +
	"\fyaml_content\x18\x06 \x01(\fR\vyamlContent\"M\n" +
	...
	"\auser_id\x18\x03 \x01(\tR\x06userId\"\xef\x02\n" +
	"\n" +
	"DaemonInfo\x12\x1b\n" +
	"\tdaemon_id\x18\x01 \x01(\tR\bdaemonId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x1a\n" +
	...
	"\x10ReportToolResult\x12#.reliant.v1.ReportToolResultRequest\x1a$.reliant.v1.ReportToolResultResponse\"\x002\x99\x02\n" +
	...
	"\x11CreateDaemonToken\x12$.reliant.v1.CreateDaemonTokenRequest\x1a%.reliant.v1.CreateDaemonTokenResponse\"\x00BCZAgithub.com/reliant-labs/reliant/internal/gen/reliant/v1;reliantv1b\x06proto3"
...
var file_reliant_v1_tools_daemon_proto_goTypes = []any{
	...
	(*ProjectDiscovery)(nil),                // 21: reliant.v1.ProjectDiscovery
	(*DiscoveredProject)(nil),               // 22: reliant.v1.DiscoveredProject
	(*ToolExecutionCancel)(nil),             // 23: reliant.v1.ToolExecutionCancel
	(*ReportToolResultRequest)(nil),         // 24: reliant.v1.ReportToolResultRequest
	(*ReportToolResultResponse)(nil),        // 25: reliant.v1.ReportToolResultResponse
	(*DaemonKillProcessRequest)(nil),        // 26: reliant.v1.DaemonKillProcessRequest
	(*DaemonKillProcessResponse)(nil),       // 27: reliant.v1.DaemonKillProcessResponse
	(*DaemonCommandRequest)(nil),            // 28: reliant.v1.DaemonCommandRequest
	(*DaemonCommandResponse)(nil),           // 29: reliant.v1.DaemonCommandResponse
	(*ListDaemonsRequest)(nil),              // 30: reliant.v1.ListDaemonsRequest
	(*ListDaemonsResponse)(nil),             // 31: reliant.v1.ListDaemonsResponse
	(*GetDaemonRequest)(nil),                // 32: reliant.v1.GetDaemonRequest
	(*GetDaemonResponse)(nil),               // 33: reliant.v1.GetDaemonResponse
	(*CreateDaemonTokenRequest)(nil),        // 34: reliant.v1.CreateDaemonTokenRequest
	(*CreateDaemonTokenResponse)(nil),       // 35: reliant.v1.CreateDaemonTokenResponse
	(*DaemonInfo)(nil),                      // 36: reliant.v1.DaemonInfo
	(*TerminalInputMessage)(nil),            // 37: reliant.v1.TerminalInputMessage
	(*TerminalResizeMessage)(nil),           // 38: reliant.v1.TerminalResizeMessage
	(*TerminalOutputMessage)(nil),           // 39: reliant.v1.TerminalOutputMessage
	(*TerminalSessionEvent)(nil),            // 40: reliant.v1.TerminalSessionEvent
	(*ProcessOutputSubscribeMessage)(nil),   // 41: reliant.v1.ProcessOutputSubscribeMessage
	(*ProcessOutputUnsubscribeMessage)(nil), // 42: reliant.v1.ProcessOutputUnsubscribeMessage
	(*ProcessOutputChunkMessage)(nil),       // 43: reliant.v1.ProcessOutputChunkMessage
...
var file_reliant_v1_tools_daemon_proto_depIdxs = []int32{
	...
	21, // 3: reliant.v1.DaemonMessage.project_discovery:type_name -> reliant.v1.ProjectDiscovery
	...
	27, // 6: reliant.v1.DaemonMessage.kill_process_response:type_name -> reliant.v1.DaemonKillProcessResponse
	29, // 7: reliant.v1.DaemonMessage.daemon_command_response:type_name -> reliant.v1.DaemonCommandResponse
	39, // 8: reliant.v1.DaemonMessage.terminal_output:type_name -> reliant.v1.TerminalOutputMessage
	40, // 9: reliant.v1.DaemonMessage.terminal_session_event:type_name -> reliant.v1.TerminalSessionEvent
	43, // 10: reliant.v1.DaemonMessage.process_output_chunk:type_name -> reliant.v1.ProcessOutputChunkMessage
	8,  // 11: reliant.v1.ServerMessage.tool_request:type_name -> reliant.v1.ToolRequest
	9,  // 12: reliant.v1.ServerMessage.heartbeat:type_name -> reliant.v1.ServerHeartbeat
	10, // 13: reliant.v1.ServerMessage.registration_ack:type_name -> reliant.v1.RegistrationAck
	23, // 14: reliant.v1.ServerMessage.tool_cancel:type_name -> reliant.v1.ToolExecutionCancel
	11, // 15: reliant.v1.ServerMessage.load_project_configs:type_name -> reliant.v1.LoadProjectConfigsRequest
	13, // 16: reliant.v1.ServerMessage.watch_project_configs:type_name -> reliant.v1.WatchProjectConfigsRequest
	14, // 17: reliant.v1.ServerMessage.unwatch_project_configs:type_name -> reliant.v1.UnwatchProjectConfigsRequest
	26, // 18: reliant.v1.ServerMessage.kill_process:type_name -> reliant.v1.DaemonKillProcessRequest
	28, // 19: reliant.v1.ServerMessage.daemon_command:type_name -> reliant.v1.DaemonCommandRequest
	37, // 20: reliant.v1.ServerMessage.terminal_input:type_name -> reliant.v1.TerminalInputMessage
	38, // 21: reliant.v1.ServerMessage.terminal_resize:type_name -> reliant.v1.TerminalResizeMessage
	41, // 22: reliant.v1.ServerMessage.process_output_subscribe:type_name -> reliant.v1.ProcessOutputSubscribeMessage
	42, // 23: reliant.v1.ServerMessage.process_output_unsubscribe:type_name -> reliant.v1.ProcessOutputUnsubscribeMessage
	15, // 24: reliant.v1.LoadProjectConfigsResponse.snapshot:type_name -> reliant.v1.ProjectConfigSnapshot
	44, // 25: reliant.v1.ProjectConfigSnapshot.mcp_configs:type_name -> reliant.v1.ProjectConfigSnapshot.McpConfigsEntry
	18, // 26: reliant.v1.ProjectConfigSnapshot.workflows:type_name -> reliant.v1.IndexedWorkflow
	19, // 27: reliant.v1.ProjectConfigSnapshot.presets:type_name -> reliant.v1.IndexedPreset
	20, // 28: reliant.v1.ProjectConfigSnapshot.scenarios:type_name -> reliant.v1.IndexedScenario
	17, // 29: reliant.v1.ProjectConfigDelta.changed_files:type_name -> reliant.v1.ChangedFile
	15, // 30: reliant.v1.ProjectConfigDelta.snapshot_if_compacted:type_name -> reliant.v1.ProjectConfigSnapshot
	0,  // 31: reliant.v1.ChangedFile.change_type:type_name -> reliant.v1.FileChangeType
	22, // 32: reliant.v1.ProjectDiscovery.projects:type_name -> reliant.v1.DiscoveredProject
	36, // 33: reliant.v1.ListDaemonsResponse.daemons:type_name -> reliant.v1.DaemonInfo
	36, // 34: reliant.v1.GetDaemonResponse.daemon:type_name -> reliant.v1.DaemonInfo
	1,  // 35: reliant.v1.DaemonInfo.status:type_name -> reliant.v1.DaemonStatus
	22, // 36: reliant.v1.DaemonInfo.projects:type_name -> reliant.v1.DiscoveredProject
	45, // 37: reliant.v1.DaemonInfo.connected_at:type_name -> google.protobuf.Timestamp
	45, // 38: reliant.v1.DaemonInfo.last_heartbeat:type_name -> google.protobuf.Timestamp
	2,  // 39: reliant.v1.TerminalSessionEvent.event_type:type_name -> reliant.v1.TerminalSessionEvent.EventType
	3,  // 40: reliant.v1.ToolsDaemonService.ConnectDaemon:input_type -> reliant.v1.DaemonMessage
	24, // 41: reliant.v1.ToolsDaemonService.ReportToolResult:input_type -> reliant.v1.ReportToolResultRequest
	30, // 42: reliant.v1.DaemonRegistryService.ListDaemons:input_type -> reliant.v1.ListDaemonsRequest
	32, // 43: reliant.v1.DaemonRegistryService.GetDaemon:input_type -> reliant.v1.GetDaemonRequest
	34, // 44: reliant.v1.DaemonRegistryService.CreateDaemonToken:input_type -> reliant.v1.CreateDaemonTokenRequest
	7,  // 45: reliant.v1.ToolsDaemonService.ConnectDaemon:output_type -> reliant.v1.ServerMessage
	25, // 46: reliant.v1.ToolsDaemonService.ReportToolResult:output_type -> reliant.v1.ReportToolResultResponse
	31, // 47: reliant.v1.DaemonRegistryService.ListDaemons:output_type -> reliant.v1.ListDaemonsResponse
	33, // 48: reliant.v1.DaemonRegistryService.GetDaemon:output_type -> reliant.v1.GetDaemonResponse
	35, // 49: reliant.v1.DaemonRegistryService.CreateDaemonToken:output_type -> reliant.v1.CreateDaemonTokenResponse
